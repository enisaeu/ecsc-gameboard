        ...
        if (isset($_POST["token"])) {
            if ($_POST["token"] !== $_SESSION["token"]) {
                ...
                if ($success) {
                    ...
                    $penalty = getDynamicScore($_POST["task_id"], null, true);
