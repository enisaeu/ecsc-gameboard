...
if [ -z "$result" ] ; then
    DEBIAN_FRONTEND=noninteractive apt-get -qq -y install apache2 php libapache2-mod-php libapache2-mod-evasive nullmailer default-mysql-server default-mysql-client php-mysql php-tcpdf php-gd php-xml php-simplexml php-apcu openssh-server unattended-upgrades cron php-curl pwgen apt-utils
else
    DEBIAN_FRONTEND=noninteractive apt-get -qq -y install apache2 php5 libapache2-mod-php5 libapache2-mod-evasive nullmailer mysql-server mysql-client php5-mysql php5-tcpdf php5-gd php5-xml php5-simplexml php5-apcu openssh-server unattended-upgrades cron php5-curl pwgen apt-utils
fi
